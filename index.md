...
no setup, no configuration. Install, register, and start working in
under 2 minutes.

![gptRBridge walkthrough](reference/figures/gptRBridge_walkthrough.gif)

gptRBridge walkthrough
...
- Send console output or error messages automatically back for instant
  diagnosis
...
subscribe after your trial ends.

**3. Start chatting**

Ask anything about your data, models, or R code. The assistant responds
with explanations and ready-to-run code blocks.

**4. Insert code**

Click the ‘Insert’ button on any code block to insert it directly into
your active RStudio editor with one click.

**5. Iterate automatically**

Console output, results, and errors are captured and passed back to the
assistant automatically, so you can iterate without copy-pasting
anything.
...
Commercial use and redistribution require written permission. See
[LICENSE.md](https://nikkn.github.io/gptRBridge/LICENSE.md) for full
terms.
